...
/**
 * FT_Widget_Products Class
 */
class FT_Widget_Products extends FT_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Add your products here.', 'flash-toolkit' );
		$this->widget_id          = 'themegrill_flash_products';
		$this->widget_name        = __( 'FT: Products', 'flash-toolkit' );
		...
		$this->settings           = apply_filters( 'flash_toolkit_widget_settings_' . $this->widget_id, array(
			'categories'  => array(
				...
				'label' => __( 'Select Product Category', 'flash-toolkit' ),
				'args'  => array(
					'hide_empty'       => 0,
					'taxonomy'         => 'product_cat',
					'show_option_all'  => __( 'All categories', 'flash-toolkit' ),
					'show_option_none' => ''
				),
	...
	public function widget( $args, $instance ) {
		...
		flash_get_template( 'content-widget-products.php', array( 'instance' => $instance ) );
