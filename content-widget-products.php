<?php
/**
 * The template for displaying products widget.
 *
 * This template can be overridden by copying it to yourtheme/flash-toolkit/content-widget-products.php.
 *
...
while ($project_query->have_posts()): $project_query->the_post();
   ...
   if ($termsArray) {
    ...
    if (has_post_thumbnail()) {
        ...
        if (isset($product)) {
            $output .= '<div data-product="' . $product->stock_quantity . '"></div>';
            ...
            if ($product->stock_quantity > 0) {
                ...
                $output .= '<h3 class="feature-title-wrap">Out of stock</h3>';
            }
        }
